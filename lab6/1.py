...
class QuizWindow(QWidget):
    def __init__(self):
        ...
        self.question_label.setStyleSheet("font-weight: bold; color: #FF0000;")
    ...
    def insert_questions_to_database(self):
        try:
            ...
            questions = [
                ("Франция чемпион мира по футболу 2018", "True"),
                ("Футбольное поле квадратное?", "False"),
                ("Хоккей зимний вид спорта?", "True"),
                ("Футбольный мяч круглый?", "True"),
                ("В футбольной команде 10 игроков?", "False")
            ]
    ...
    def show_question(self):
        if self.current_question < len(self.questions):
            ...
            self.question_label.setText("Вы ответили правильно на {} вопрос(а/ов)".format(self.correct_answers))

    def check_answer(self, user_answer):
        _, correct_answer = self.questions[self.current_question]

        if user_answer == (correct_answer == "True"):
            QMessageBox.information(self, "Правильно!", "Вы правильно ответили!")
